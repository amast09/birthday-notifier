...
module ConnectionsResponse (Connection, ConnectionsResponse, Day, connections, names, birthdays) where

import Data.Aeson
import GHC.Generics

data Day = Day { year :: Int, month :: Int, day :: Int } deriving (Eq, Generic, Show)
...
data Name = Name { displayName :: String } deriving (Eq, Generic, Show)
